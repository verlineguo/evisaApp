        ...
        <div class="card shadow mb-4">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
                <label for="idCountry">Country ID</label>
                <input type="text" class="form-control" id="idCountry" name="idCountry" value="{{ old('idCountry', isset($country) ? $country->idCountry : '') }}" {{ isset($country) ? 'readonly' : '' }}>
            </div>
