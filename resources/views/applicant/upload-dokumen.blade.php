...
@section('content')
  <div class="px-32 py-16">
        ...
        @csrf
          <div class="border-b border-gray-900/10 pb-12">
            ...
            <div class="col-span-full mt-20 ">
                <label for="ktp" class="block text-sm/6 font-medium text-gray-900">Fotokopi KTP</label>
            ...
            <div class="col-span-full mt-12 ">
                <label for="kk" class="block text-sm/6 font-medium text-gray-900">Kartu Keluarga</label>
                <div class="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
                    <div class="text-center">
                        <svg class="mx-auto size-12 text-gray-300" viewBox="0 0 24 24" fill="currentColor"
                            aria-hidden="true" data-slot="icon">
            ...
            <div class="col-span-full mt-12">
                <label for="aktalahir" class="block text-sm/6 font-medium text-gray-900">Akta Kelahiran</label>
                <div class="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
                    <div class="text-center">
                        <svg class="mx-auto size-12 text-gray-300" viewBox="0 0 24 24" fill="currentColor"
                            aria-hidden="true" data-slot="icon">
      ...
      <div class="mt-6 flex items-center justify-end gap-x-6 px-32 py-8">
